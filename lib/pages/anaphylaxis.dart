        ...
        child: Column(
          ...
          children: [
            const ListTile(
              ...
              subtitle: Text('If the person has been prescribed an epinephrine auto-injector (such as EpiPen), help them use it immediately. Instruct them to inject it into their thigh muscle.'),
            ),
            ElevatedButton(
              onPressed: () => Navigator.of(context).pushReplacement(
            ...
            const ListTile(
              ...
              subtitle: Text('Follow the specific instructions provided with the auto-injector. Typically, it involves holding the injector in place for a few seconds.'),
            ),
            const ListTile(
              leading: Icon(Icons.phone_in_talk),
              title: Text('Activate Emergency Services'),
              subtitle: Text('Call emergency services immediately and inform them that the person is experiencing anaphylaxis.'),
            ),
            const ListTile(

...
import 'age.dart';
import 'rescue_breath.dart'; // Make sure to create this page in your project

class UnnotBreathingPage extends StatelessWidget {
  const UnnotBreathingPage({Key? key}) : super(key: key);
  static const String routeName = '/UnnotBreathingPage';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Rescue Breath instructions'),
            ),
          ],
        ),
      ),
